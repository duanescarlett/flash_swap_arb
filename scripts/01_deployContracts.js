...
// require("../artifacts/contracts/WETH.sol/WETH.json")
...
async function main() {
  ...
  // NonfungibleTokenPositionDescriptor = new ContractFactory(artifacts.NonfungibleTokenPositionDescriptor.abi, artifacts.NonfungibleTokenPositionDescriptor.bytecode, owner);
  NonfungibleTokenPositionDescriptor = new ContractFactory(artifacts.NonfungibleTokenPositionDescriptor.abi, linkedBytecode, owner); // artifacts.NonfungibleTokenPositionDescriptor.bytecode
